...
import com.coredropship.objectRepository.InventoryDetails;
import com.coredropship.objectRepository.LoginPage;

public class CreateProductTest2New
{
	...
	public static void main(String[] args) 
	{
		...
		//open n read data from property file
		...
		long timeout = Long.parseLong(fileUtility.getDataFromProprtyFile(PropertyFileKeys.TIMEOUT.convertToString()));
		...
		String actualID = excelUtility.getDataFromExcel( SheetName.PRODUCT.toString(), 3, 1);
		String pName = excelUtility.getDataFromExcel( SheetName.PRODUCT.toString(), 3, 2);
		String description = excelUtility.getDataFromExcel( SheetName.PRODUCT.toString(), 3, 3);
		String qnt = excelUtility.getDataFromExcel( SheetName.PRODUCT.toString(), 3, 4);
		String onHand = excelUtility.getDataFromExcel( SheetName.PRODUCT.toString(),3 , 5);
		String price = excelUtility.getDataFromExcel( SheetName.PRODUCT.toString(), 3, 6);
		String ctg = excelUtility.getDataFromExcel( SheetName.PRODUCT.toString(), 3, 7);
		String supplier = excelUtility.getDataFromExcel(SheetName.PRODUCT.toString(), 3, 8);
		String dateStockIn = excelUtility.getDataFromExcel( SheetName.PRODUCT.toString(), 3, 9);
		...
		InventoryDetails  inventorydetails=new InventoryDetails(driver);
		...
		commonpage.clickInventory();
		inventorydetails.clickOnInventorySearchBox(pName);
		inventorydetails.compareInventorySearchResults(pName);
