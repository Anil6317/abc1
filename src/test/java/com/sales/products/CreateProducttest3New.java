...
import com.coredropship.objectRepository.EditProductDetailsPage;
import com.coredropship.objectRepository.LoginPage;

public class CreateProducttest3New {
	...
	public static void main(String[] args) 
	{
		...
		String expectedText=excelUtility.getDataFromExcel(SheetName.PRODUCT.toString(), 2, 14);
		//open the browser
		...
		EditProductDetailsPage editproductdetailsPage=new EditProductDetailsPage(driver);
		...
		createproductpage.clickOnThreeDotsEditIconForProduct(actualID);
		createproductpage.editButtonForProduct();
		editproductdetailsPage.updateProductName(pName);
		editproductdetailsPage.updateProductCategory(webdriverutility, ctg);
		editproductdetailsPage.clickOnUpdate();
		editproductdetailsPage.verifyText(webdriverutility, expectedText);
